...
Finally, the following matching reusable action performs the matching and generates output files. Remember to replace [version] with a matching version:
...
match:
  ...
  outputs:
    highly_sensitive:
      ...
      matched_controls: output/matched_controls.arrow
...
file by writing it in a previous action, e.g.
